...
describe("Security Integration Tests", function () {
  ...
  describe("Emergency Response System", function () {
    ...
    it("Should handle circuit breaker activation", async function () {
      ...
      await expect(
        fixture.celerIMModule.bridgeToken(10, user1.address, 100, { value: 100 })
  ...
  describe("Input Validation", function () {
    ...
    it("Should validate amount boundaries", async function () {
      // Test zero amount
      await expect(
        fixture.celerIMModule.bridgeToken(10, user1.address, 0, { value: 100 })
    ...
    it("Should validate chain IDs", async function () {
      ...
      await expect(
        fixture.celerIMModule.bridgeToken(0, user1.address, 100, { value: 100 })
